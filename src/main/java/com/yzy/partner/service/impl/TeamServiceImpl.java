...
import com.yzy.partner.model.domain.UserTeam;
import com.yzy.partner.model.dto.TeamQuery;
import com.yzy.partner.model.enums.TeamStatusEnum;
...
import com.yzy.partner.model.vo.UserVO;
import com.yzy.partner.service.TeamService;
import com.yzy.partner.model.domain.Team;
import com.yzy.partner.mapper.TeamMapper;
import com.yzy.partner.service.UserService;
import com.yzy.partner.service.UserTeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("yzy:join_team");
        try {
            // 抢到锁并执行
            while (true) {
