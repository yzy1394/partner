...
public class ImportUser {
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<PartnerTableUserInfo>> listMap =
                userInfoList.stream()
                        .filter(userInfo -> StringUtils.isNotEmpty(userInfo.getUsername()))
                        .collect(Collectors.groupingBy(PartnerTableUserInfo::getUsername));
        for (Map.Entry<String, List<PartnerTableUserInfo>> stringListEntry : listMap.entrySet()) {
